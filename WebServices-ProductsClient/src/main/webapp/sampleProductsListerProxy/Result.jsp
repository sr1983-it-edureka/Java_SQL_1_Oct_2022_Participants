...
<jsp:useBean id="sampleProductsListerProxyid" scope="session" class="com.edureka.javasql1.webservices.products.ProductsListerProxy" />
<%
...
case 10:
        gotMethod = true;
        com.edureka.javasql1.webservices.products.ProductsLister getProductsLister10mtemp = sampleProductsListerProxyid.getProductsLister();
...
case 13:
        ...
        java.lang.String list13mtemp = sampleProductsListerProxyid.list(category_1idTemp);
if(list13mtemp == null){
%>
<%=list13mtemp %>
<%
}else{
        String tempResultreturnp14 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(list13mtemp));
        %>
        <%= tempResultreturnp14 %>
        <%
}
