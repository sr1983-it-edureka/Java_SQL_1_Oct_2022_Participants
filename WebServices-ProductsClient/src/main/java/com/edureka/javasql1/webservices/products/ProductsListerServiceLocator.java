...
public class ProductsListerServiceLocator extends org.apache.axis.client.Service implements com.edureka.javasql1.webservices.products.ProductsListerService {
    ...
    public com.edureka.javasql1.webservices.products.ProductsLister getProductsLister() throws javax.xml.rpc.ServiceException {
    ...
    public com.edureka.javasql1.webservices.products.ProductsLister getProductsLister(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.edureka.javasql1.webservices.products.ProductsListerSoapBindingStub _stub = new com.edureka.javasql1.webservices.products.ProductsListerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.edureka.javasql1.webservices.products.ProductsLister.class.isAssignableFrom(serviceEndpointInterface)) {
                com.edureka.javasql1.webservices.products.ProductsListerSoapBindingStub _stub = new com.edureka.javasql1.webservices.products.ProductsListerSoapBindingStub(new java.net.URL(ProductsLister_address), this);
                _stub.setPortName(getProductsListerWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://products.webservices.javasql1.edureka.com", "ProductsListerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://products.webservices.javasql1.edureka.com", "ProductsLister"));
        }
