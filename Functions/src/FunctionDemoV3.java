...
public class FunctionDemoV3 {
	...
	static void openBrowserFacebook(){
	...
	static void openBrowserInstagram(){
		
		// Open a Browser
		
		System.out.println("Opening Browser....");
		System.out.println("Chrome Browser Opened....");
		System.out.println("The website instagram.com is opened");	
		System.out.println();
	}
	
	static void openBrowserTwitter(){
		
		// Open a Browser
		
		System.out.println("Opening Browser....");
		System.out.println("Chrome Browser Opened....");
		System.out.println("The website twitter.com is opened");	
		System.out.println();
	}	
